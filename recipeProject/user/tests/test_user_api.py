...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        self.assertEqual(res.status_code,status.HTTP_201_CREATED) # compare the status
    ...
    def test_user_exists(self):
        ...
        self.assertEqual(res.status_code,status.HTTP_400_BAD_REQUEST) # Bad request because the user already exists
