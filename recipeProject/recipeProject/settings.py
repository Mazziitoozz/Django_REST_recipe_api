...
SECRET_KEY = 'n-2s8_mi%nlz5h$x4jbs--!65jiai%uqx%smi+f31cg5c48m0k'
...
AUTH_USER_MODEL = 'core.User' # core is the name of our app and User is the name of the model in pur app